...
const cluster_reconnection_tracker_1 = __importDefault(require("./cluster-reconnection-tracker"));
...
class RedisClusterSlots {
    ...
    async #discoverWithKnownNodes(excludedAddresses) {
        ...
        return (await this.#discoverWithKnownNodeCandidates(candidates) ||
