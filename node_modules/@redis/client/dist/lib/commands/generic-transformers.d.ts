...
export declare function transformTuplesToMap<T>(reply: UnwrapReply<ArrayReply<any>>, func: (elem: any) => T): Record<string, T>;
...
export declare function transformStreamsMessagesReplyResp3(reply: UnwrapReply<StreamsMessagesRawReply3 | NullReply>, typeMapping?: TypeMapping): MapReply<BlobStringReply, StreamMessagesReply> | NullReply;
/**
 ...
 */
export declare function transformStreamsMessagesReplyResp3Compat(reply: ReplyUnion, preserve?: any, typeMapping?: TypeMapping): {
    name: any;
    messages: any;
}[] | null;
