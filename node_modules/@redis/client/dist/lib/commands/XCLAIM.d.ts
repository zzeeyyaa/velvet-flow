...
declare const _default: {
     ...
     */
    readonly transformReply: (this: void, reply: UnwrapReply<ArrayReply<StreamMessageRawReply | NullReply>>, preserve?: unknown, typeMapping?: TypeMapping) => (NullReply | import("./generic-transformers").StreamMessageReply)[];
};
