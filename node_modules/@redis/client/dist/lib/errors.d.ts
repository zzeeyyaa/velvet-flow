...
export declare class ScanIteratorInterruptedError extends Error {
...
export declare class SocketTimeoutDuringMaintenanceError extends TimeoutError {
    constructor(timeout: number);
}
export declare class CommandTimeoutDuringMaintenanceError extends TimeoutError {
    constructor(timeout: number);
}
...
export declare class OpenTelemetryError extends Error {
}
