        ...
        return new Promise((resolve, reject) => {
            ...
            if (timeout) {
                ...
                value.timeout = {
                    ...
                    listener: () => {
                        this.#toWrite.remove(node);
                        value.reject(wasInMaintenance
                            ? new errors_1.CommandTimeoutDuringMaintenanceError(timeout)
        ...
        this.decoder.onReply = ((reply) => {
            if (Array.isArray(reply)) {
                ...
                if (PONG.equals(firstElement)) {
                    ...
                    resolve(typeMapping?.[decoder_1.RESP_TYPES.SIMPLE_STRING] === Buffer
                        ? buffer
                        : buffer.toString());
                    return;
                }
    ...
    *commandsToWrite() {
    ...
    extractCommandsForSlots(slots) {
        ...
        while (current !== undefined) {
            if (current.value.slotNumber !== undefined &&
