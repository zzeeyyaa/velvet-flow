...
export declare const dbgMaintenance: (...args: unknown[]) => void;
...
export default class EnterpriseMaintenanceManager {
    #private;
    static setupDefaultMaintOptions(options: AnyRedisClientOptions): void;
    static getHandshakeCommand(options: AnyRedisClientOptions, clientId: string): Promise<{
        cmd: Array<RedisArgument>;
        errorHandler: (error: Error) => void;
    } | undefined>;
    constructor(commandsQueue: RedisCommandsQueue, client: RedisType, options: AnyRedisClientOptions);
    /**
