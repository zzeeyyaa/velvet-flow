...
type CommandSignature<REPLIES extends Array<unknown>, C extends Command, M extends RedisModules, F extends RedisFunctions, S extends RedisScripts, RESP extends RespVersions, TYPE_MAPPING extends TypeMapping> = (...args: Tail<Parameters<C['parseCommand']>>) => RedisClientMultiCommandTyped<[
    ...REPLIES,
...
export default class RedisClientMultiCommand<REPLIES = []> {
    #private;
    static extend<M extends RedisModules = Record<string, never>, F extends RedisFunctions = Record<string, never>, S extends RedisScripts = Record<string, never>, RESP extends RespVersions = 3>(config?: CommanderConfig<M, F, S, RESP>): any;
     ...
     * in the future.
     */
    sendCommand(args: ReadonlyArray<RedisArgument>): this;
}
export {};
