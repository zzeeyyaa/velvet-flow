...
exports.transformMultiAggregationSamplesReply = {
    2(reply) {
        return reply
            .map(sample => exports.transformMultiAggregationSampleReply[2](sample));
    },
    3(reply) {
        return reply
            .map(sample => exports.transformMultiAggregationSampleReply[3](sample));
    }
};
